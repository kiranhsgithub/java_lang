 ...
 *
 */
public class SyncCollectionTester extends Thread{

List<String> names2;
	
	public SyncCollectionTester()
	{
		//names2 = Collections.synchronizedList(new ArrayList<String>());
	...
	public static void main(String[] args) {
		...
		List<String> names1 = new ArrayList<String>();
		 ...
		 SyncCollectionTester um = new SyncCollectionTester();
		um.start();
